...
export default function Signup2() {
    // 배열 + reduce() 함수
    const initArray = [
        'id', 'pass', 'name', 'phone1', 'phone2', 'phone3', 'address',
        'birth1', 'birth2', 'birth3', 'job', 'gender', 'email', 'intro'
    ];
    ...
    const refs = {
        ...
        jobRef: useRef(null),
        genderRef: [useRef(null), useRef(null)],
            ...
            <form onSubmit={handleSubmit}>
                <ul style={{'list-style-type':'none','margin':0,'padding':0}}>
                    ...
                    <li>
                        ...
                        <input type="radio" name="gender" value="m" ref={refs.genderRef} onChange={ handleChangeForm }/>남
                        <input type="radio" name="gender" value="f" ref={refs.genderRef} onChange={ handleChangeForm }/>여
                    </li>
                    <li>
